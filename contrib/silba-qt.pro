...
RESOURCES += src/qt/silba.qrc src/qt/silba_locale.qrc

TRANSLATIONS += src/qt/locale/silba_bg.ts \
                src/qt/locale/silba_de.ts \
                src/qt/locale/silba_en.ts \
                src/qt/locale/silba_es.ts \
                src/qt/locale/silba_fi.ts \
                src/qt/locale/silba_fr.ts \
                src/qt/locale/silba_it.ts \
                src/qt/locale/silba_ja.ts \
                src/qt/locale/silba_pl.ts \
                src/qt/locale/silba_pt.ts \
                src/qt/locale/silba_ru.ts \
                src/qt/locale/silba_sk.ts \
                src/qt/locale/silba_sv.ts \
                src/qt/locale/silba_vi.ts \
                src/qt/locale/silba_zh_CN.ts \
                src/qt/locale/silba_zh_TW.ts
