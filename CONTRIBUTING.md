Contributing to Silba Core
============================

The Silba Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/silba-project/silba/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Silba Core project, and is not to be
confused with overall Silba Network Protocol consensus changes.

Whether a pull request is merged into Silba Core rests with the project merge
...
Patches that change Silba consensus rules are considerably more involved than
...
Where a patchset proposes to change the Silba consensus, it must have been
...
The project leader is the release manager for each Silba Core release.
