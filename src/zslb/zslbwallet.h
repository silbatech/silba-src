...
#ifndef Silba_ZSLBWALLET_H
#define Silba_ZSLBWALLET_H
...
public:
    CzSLBWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZSLB(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSLB(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
