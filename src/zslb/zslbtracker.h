...
#ifndef Silba_ZSLBTRACKER_H
#define Silba_ZSLBTRACKER_H
...
public:
    CzSLBTracker(std::string strWalletFile);
    ~CzSLBTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzSLBWallet* zSLBWallet = NULL);
