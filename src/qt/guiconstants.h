...
/* Silba GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Silba"
#define QAPP_ORG_DOMAIN "silba.org"
#define QAPP_APP_NAME_DEFAULT "Silba-Qt"
#define QAPP_APP_NAME_TESTNET "Silba-Qt-testnet"
