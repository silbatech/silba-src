...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::SLB);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeSilbaAmount"))
        SoftSetArg("-anonymizesilbaamount", settings.value("nAnonymizeSilbaAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in silba.cpp during shotdown to also remove the window positions
