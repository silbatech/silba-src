...
/** Utility functions used by the Silba Qt UI.
 */
namespace GUIUtil
{
...
// Render Silba addresses in monospace font
...
// Parse "silba:" URI into recipient object, return true on successful parsing
