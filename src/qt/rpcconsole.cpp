                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSLBPathCustom = GetArg("-zslbbackuppath", "");
    ...
    if(!strzSLBPathCustom.empty()) {
        ui->wallet_customzslbbackuppath->setText(QString::fromStdString(strzSLBPathCustom));
        ui->wallet_customzslbbackuppath_label->setVisible(true);
        ui->wallet_customzslbbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSLBPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Silba RPC console.") + "<br>" +
