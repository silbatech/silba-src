...
extern UniValue DoZslbSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzslbseed(const UniValue& params, bool fHelp);
extern UniValue getzslbseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzslb(const UniValue& params, bool fHelp);
extern UniValue dzslbstate(const UniValue& params, bool fHelp);
