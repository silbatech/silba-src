...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Silba features */
        {"silba", "listmasternodes", &listmasternodes, true, true, false},
        {"silba", "getmasternodecount", &getmasternodecount, true, true, false},
        {"silba", "masternodeconnect", &masternodeconnect, true, true, false},
        {"silba", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"silba", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"silba", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"silba", "masternodecurrent", &masternodecurrent, true, true, false},
        {"silba", "masternodedebug", &masternodedebug, true, true, false},
        {"silba", "startmasternode", &startmasternode, true, true, false},
        {"silba", "createmasternodekey", &createmasternodekey, true, true, false},
        {"silba", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"silba", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"silba", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"silba", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"silba", "getmasternodescores", &getmasternodescores, true, true, false},
        {"silba", "preparebudget", &preparebudget, true, true, false},
        {"silba", "submitbudget", &submitbudget, true, true, false},
        {"silba", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"silba", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"silba", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"silba", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"silba", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"silba", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"silba", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"silba", "checkbudgets", &checkbudgets, true, true, false},
        {"silba", "mnsync", &mnsync, true, true, false},
        {"silba", "spork", &spork, true, true, false},
        {"silba", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzslbseed", &getzslbseed, false, false, true},
        {"zerocoin", "setzslbseed", &setzslbseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzslb", &searchdzslb, false, false, true},
        {"zerocoin", "dzslbstate", &dzslbstate, false, false, true},
...
{
    return "> silba-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:26543/\n";
}
