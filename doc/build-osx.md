...
1. Clone the Silba Core source code:

        git clone https://github.com/silba-project/silba
        cd silba
...
Silba Core is now available at `./src/silbad`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/Silba"

    touch "/Users/${USER}/Library/Application Support/Silba/silba.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Silba/silba.conf"

The first time you run silbad, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/Silba/debug.log

Other commands:
-------

    ./src/silbad -daemon # Starts the silba daemon.
    ./src/silba-cli --help # Outputs a list of command-line options.
    ./src/silba-cli help # Outputs a list of RPC commands when the daemon is running.
