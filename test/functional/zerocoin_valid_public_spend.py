...
from fake_stake.base_test import Silba_FakeStakeTest

class zSLBValidCoinSpendTest(Silba_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zSLBs..." % DENOM_TO_USE)
